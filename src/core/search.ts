...
async function scrapeDDG(query: string, max: number, time?: SearchTimeWindow, locale = "en-us", signal?: AbortSignal): Promise<SearchHit[]> {
...
async function scrapeBing(query: string, max: number, _time?: SearchTimeWindow, signal?: AbortSignal): Promise<SearchHit[]> {
...
async function searchSearXNG(baseUrl: string, query: string, max: number, timeoutMs = 10_000, time?: SearchTimeWindow, signal?: AbortSignal): Promise<SearchHit[]> {
